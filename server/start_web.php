...
// composer autoload
require_once join(DIRECTORY_SEPARATOR, array(__DIR__, "..", "libs", "socketio", "vendor", "autoload.php"));

$web = new Worker('http://0.0.0.0:2022');
$web->name = 'web';

define('WEBROOT', join(DIRECTORY_SEPARATOR, array(__DIR__, "..", "public", "desktop")));
